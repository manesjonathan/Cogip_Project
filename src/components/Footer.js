        ...
        <footer classeName = "footer">
            <nav className="social-container">
                ...
                <ul className="social-media">
                    ...
                    <li>
                        <img className="logo-instagram" src={Instagram} alt="logo instagram"  />
                    </li>
                    <li>
                        <img className="logo-googleplus" src={Googleplus} alt="logo googleplus"  />
                    </li>
                    <li>
                        <img className="logo-pinterest" src={Pinterest} alt="logo pinterest"  />
                    </li>
                    <li>
